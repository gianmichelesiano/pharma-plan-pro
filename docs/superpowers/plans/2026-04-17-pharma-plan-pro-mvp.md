...
Open https://supabase.com/dashboard/project/tgwuvvptqjnqzvcphvbn/editor → `employees` exists with the columns above.
...
Open https://supabase.com/dashboard/project/tgwuvvptqjnqzvcphvbn/editor → `employees` table → should show 19 rows.
